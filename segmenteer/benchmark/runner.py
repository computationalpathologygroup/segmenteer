...
from segmenteer.metrics.evaluation import SupervisedMetrics, compute_all_supervised_metrics
from segmenteer.metrics.unsupervised import UnsupervisedMetrics, compute_unsupervised_metrics
...
class BenchmarkRunner:
    ...
    def run_single(
        ...
        if ground_truth_geojson is not None:
            ...
            supervised = compute_all_supervised_metrics(geojson_result, ground_truth_geojson)
